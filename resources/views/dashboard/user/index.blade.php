    ...
    <div class="widget-box">
        <div class="widget-header">
            ...
            <div class="widget-toolbar">
                <a href="{{ route('dashboard.create-user') }}" class="btn btn-xs btn-primary">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="hidden-sm hidden-xs action-buttons">
                                                                    <a class="blue"
                                                                    href="{{ route('dashboard.show-user', $user->id) }}">
                                                                        <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                                    </a>

                                                                    <a class="green"
                                                                        href="{{ route('dashboard.edit-user', $user->id) }}">
                                                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                                    </a>

                                                                    <a class="red"
                                                                        href="{{ route('dashboard.delete-user', $user->id) }}">
