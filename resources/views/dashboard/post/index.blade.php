    ...
    <div class="widget-box">
        <div class="widget-header">
            ...
            <div class="widget-toolbar">
                <a href="{{ route('dashboard.create-post') }}" class="btn btn-xs btn-primary">
                                                ...
                                                @isset($posts)
                                                    @foreach ($posts as $post)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="70">
                                                                @if (!empty($post->photo))
                                                                    <a href="{{ Storage::url($post->photo) }}">
                                                                    <img src="{{ Storage::url($post->photo) }}" width="60">
                                                                </a>
                                                                @else
                                                            ...
                                                            <td>
                                                                <div class="hidden-sm hidden-xs action-buttons">
                                                                    <a class="blue"
                                                                    href="{{ route('dashboard.show-post', $post->id) }}">
                                                                        <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                                    </a>

                                                                    <a class="green"
                                                                        href="{{ route('dashboard.edit-post', $post->id) }}">
                                                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                                    </a>

                                                                    <a class="red"
                                                                        href="{{ route('dashboard.delete-post', $post->id) }}">
